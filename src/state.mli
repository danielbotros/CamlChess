(** Takes a board object and returns a new board object. *)
...
val current_state : t -> string list list
(** [current_state st] is the 2 dimensional list of the all the chess pieces in
    their positions in state [st] *)
...
val move : int * int -> Board.t -> int * int -> result
(** [move start board end] is the result of attempting to move piece at position
